...
@section('css')
<link rel="stylesheet" href="{{'css/messageexecutive.css'}}">
@endsection('css')
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-4 mb-3">
            <div class="card">
                    <img src="{{'images/managementboard/harimaskey.png'}}" class="card-img-top" alt="">
                    <div class="card-body">
                        <h5 class="card-title">Mr Hari Maskey</h5>
                        <h5 class="card-subtitle text-muted">Founder and Executive</h5>
                        <div ><i class="fa-solid fa-envelope pe-2"></i><span>tnshrestah@gmail.com</span></div>
